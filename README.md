...
Instalação
Clonar e entrar na pasta: git clone [https://github.com/seu-usuario/MobileTicketsIonic.git](https://github.com/Otavio-Martins18/MobileTicketsIonic.git) cd MobileTicketsIonic
